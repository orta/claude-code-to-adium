...
<html><head>
	...
	<base href="file:///Applications/Adium.app/Contents/Resources/Message%20Styles/Renkoo.AdiumMessageStyle/Contents/Resources/">
...
<body onload="initStyle();" style="margin-top: 5px;">

<div id="Chat" class="" style="position: relative; top: 176px;">
<div class="x-chatItem x-outgoingItem outgoing message" style="opacity: 0.95; visibility: visible;">	<table width="100%">		<tbody><tr>			<td valign="top">				<img src="Outgoing/buddy_icon.png" class="x-avatar" title="orta therox">				<div class="x-myBubble">					<div class="x-indicator"></div>					<table class="x-tableBubble" cellspacing="0" cellpadding="0">						<tbody><tr>							<td class="x-tl"></td>							<td class="x-tr"></td>						</tr>						<tr>							<td class="x-message">								Hello world								<div class="x-timeStamp" title="12 Jul 2025"><span class="x-name">orta therox @</span> 16:59</div>								<span id="insert"></span>							</td>							<td class="x-messageRight"></td>						</tr>						<tr>							<td class="x-bl"></td>							<td class="x-br"></td>						</tr>					</tbody></table>				</div>			</td>		</tr>	</tbody></table></div></div>
